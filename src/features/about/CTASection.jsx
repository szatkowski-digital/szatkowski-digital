...
export const CTASection = ({ t }) => {
  return (
    <section className="pb-32 mx-auto">
      <div className="glass-card p-12 md:p-24 rounded-[40px] text-center relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-1 bg-linear-to-r from-primary-pink to-primary-aqua" />

        <h2 className="text-4xl md:text-7xl font-display font-bold uppercase mb-12 tracking-tighter">
          {t.title1} <br />
